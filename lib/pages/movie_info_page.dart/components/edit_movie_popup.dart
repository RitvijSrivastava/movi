...
class EditMoviePopup extends StatefulWidget {
  final Movie movie;
  final int index;

  const EditMoviePopup({Key? key, required this.movie, required this.index})
      : super(key: key);

  @override
  _EditMoviePopupState createState() => _EditMoviePopupState();
}

class _EditMoviePopupState extends State<EditMoviePopup> {
  ...
  void initState() {
    ...
    _movieDirector = widget.movie.movieDirector;
  ...
  void _handleOnSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      _movieBloc.movieEventSink
          .add(EditMovie(movie: movie, index: widget.index));

      // Show success message
      final snackBar = SnackBar(content: Text('Movie edited successfully!'));
